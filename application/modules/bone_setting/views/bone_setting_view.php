<div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Bone Setting</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="modal-body">
                              <form method="post" id="user_form" enctype="multipart/form-data">   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="option" id="option" class="form-control" placeholder="Option" />
                                        </div>
                                    </div>
                                     <br>
                                     <hr>
  ...
  <script>  
    ...
    function Ubah_Data(id){
        ...
        $.ajax({
             url:"<?php echo base_url(); ?>bone_setting/get_data_edit/"+id,
             type:"GET",
             dataType:"JSON", 
    ...
    function Hapus_Data(id){
        ...
        { 
        $.ajax({
            url : "<?php echo base_url('bone_setting/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
    ...
    function Simpan_Data(){ 
         var formData = new FormData($('#user_form')[0]);   
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>bone_setting/simpan_data_bone_setting",
             type:"POST",
             data:formData,
             contentType:false,  
             processData:false,   
    ...
    $(document).ready(function() {
           ...
           $("#example1").DataTable({
              "ajax":"<?php echo base_url(); ?>bone_setting/fetch_bone_setting",
