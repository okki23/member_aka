<div class="row">
  ...
  <script>  
    ...
    function Ubah_Data(id){
        ...
        $.ajax({
             url:"<?php echo base_url(); ?>barcode/get_data_edit/"+id,
             type:"GET",
             dataType:"JSON", 
    ...
    function Hapus_Data(id){
        ...
        { 
        $.ajax({
            url : "<?php echo base_url('barcode/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
    ...
    function Simpan_Data(){ 
         var formData = new FormData($('#user_form')[0]);   
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>barcode/simpan_data_barcode",
             type:"POST",
             data:formData,
             contentType:false,  
             processData:false,   
    ...
    $(document).ready(function() {
           ...
           $("#example1").DataTable({
              "ajax":"<?php echo base_url(); ?>barcode/fetch_barcode",
